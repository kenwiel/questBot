...
public class Settings {
    ...
    public static String loadMod() {
        File tokenFile = new File(directory + "mod");
        if (tokenFile.exists()) {
        ...
        writeFile(tokenFile, "enter mod role id here. This file should only contain \"roleID\", including the quotes.");
        return "";
